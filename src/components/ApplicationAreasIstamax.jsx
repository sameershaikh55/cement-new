				...
				<div className="row mt-4">
					<div className="col-12 col-sm-10 col-lg-8 mx-auto">
						<div className="row">
							...
							>
								<img width="35%" src={area1} alt="AAC Blocks" />
							...
							<div
								...
								className="aresCard col-3 text-center mt-4"
							>
								<img width="37%" src={area2} alt="Bricks" />
							...
							<div
								...
								className="aresCard col-3 text-center mt-4"
							>
								<img width="38%" src={area3} alt="Concrete Blocks" />
							...
							<div
								...
								className="aresCard col-3 text-center mt-4"
							>
								 width="43%" src={area4} alt="SuitableSubstrates" />
