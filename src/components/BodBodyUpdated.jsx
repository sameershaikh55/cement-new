...
const BodBodyUpdated = ({ boardDirectors }) => {
				...
				{(!change && (
					<div className="row">
						<div className="col-11 mx-auto">
							<div className="row">
								{boardDirectors.data.board_of_director_detail[0].Nuvoco_Vistas_Crop_Ltd.map(
									(prev, i) => {
										const {
											person_photo,
											person_name,
										...
										return (
											<div key={i} className="col-12">
												<div className="row">
													...
													{boardDirectors.data.board_of_director_detail[0]
					...
					<div className="row">
						<div className="col-11 mx-auto">
							<div className="row">
								{boardDirectors.data.board_of_director_detail[1].NU_Vistas_Limited.map(
									(prev, i) => {
										const {
											person_photo,
											person_name,
										...
										return (
											<div key={i} className="col-12">
												<div className="row">
													...
													{boardDirectors.data.board_of_director_detail[1]
